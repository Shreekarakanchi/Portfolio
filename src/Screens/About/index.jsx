      ...
      <div className='about-screen-wrapper'>
        ...
        <div>
          <div className='about-me'>
            <div>
              Hello, I’m <strong className='highlight'>Shreenivas Karakanchi</strong>, a Software Engineer at <strong className='highlight'>COFFEEWEB TECHNOLOGIES PVT. LTD.</strong>, with over <strong className='highlight'>3 years</strong> of experience in software development. I specialize in designing and developing scalable web applications, leveraging my expertise in both frontend and backend technologies.
            </div>
